...
class MenuItem extends StatelessWidget {
  ...
  const MenuItem({super.key, this.width = 228, this.height, this.padding = 16, required this.imageAssetUrl, required this.itemName, required this.itemDescription, required this.itemPrice});
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        SFIcon(
                          ...
                          fontWeight:
                              FontWeight.normal, // fontWeight instead of weight
                          color: SnackishStyles.menuItemHeroPrice.color,
                        ),
                        Text(itemPrice.toString(), style: SnackishStyles.menuItemPrice,),
                      ],
                    ),
                    Row(
                      spacing: 4,
                      children: [
                        ...
                        SFIcon(
                          ...
                          fontSize: SnackishStyles
                              .menuItemBody
                              .fontSize! - 1, // fontSize instead of size
                          fontWeight:
                              FontWeight.normal, // fontWeight instead of weight
...
class MenuItemData {
  ...
  MenuItemData(this.imageAssetUrl, this.itemName, this.itemDescription, this.itemPrice);
}
